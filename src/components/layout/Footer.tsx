          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                title="GitHub"
                aria-label="Open Finance AI GitHub profile (opens in a new tab)"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
              ...
              <a
                ...
                className="p-2 rounded-lg text-muted-foreground hover:text-primary hover:bg-muted transition-colors"
                title="Twitter"
                aria-label="Open Finance AI Twitter profile (opens in a new tab)"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
              ...
              <a
                ...
                className="p-2 rounded-lg text-muted-foreground hover:text-primary hover:bg-muted transition-colors"
                title="LinkedIn"
                aria-label="Open Finance AI LinkedIn profile (opens in a new tab)"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
        ...
        <div className="border-t border-border mt-10 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground">
              ...
              <span className="px-2 py-1 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-md font-medium">
                Powered by AI
              </span>
            </div>
          </div>
